      ...
      if (page) {
        ...
        if (isStandalone) {
          ...
          if (isPubDomain) {
            ...
            injectCode.css = `${injectCode.css}\n#fs-toggle-btn { position: fixed !important; bottom: 30px !important; right: 30px !important; z-index: 999999 !important; background: #1976d2 !important; color: #fff !important; border: none !important; border-radius: 24px !important; padding: 12px 24px !important; cursor: pointer !important; font-size: 16px !important; box-shadow: 0 2px 8px rgba(0,0,0,0.3) !important; display: flex !important; align-items: center !important; gap: 8px !important; }\n.standalone-fullscreen { position: fixed !important; top: 0 !important; left: 0 !important; width: 100vw !important; height: 100vh !important; z-index: 99999 !important; overflow: auto !important; background: #fff !important; }.standalone-fullscreen .v-toolbar, .standalone-fullscreen header, .standalone-fullscreen nav-header, .standalone-fullscreen .v-navigation-drawer, .standalone-fullscreen .page-header-section, .standalone-fullscreen .v-divider, .standalone-fullscreen .page-edit-fab, .standalone-fullscreen .page-edit-shortcuts, .standalone-fullscreen .nav-footer, .standalone-fullscreen .page-toc-card, .standalone-fullscreen .page-tags-card, .standalone-fullscreen .page-comments-card, .standalone-fullscreen .page-author-card, .standalone-fullscreen .page-shortcuts-card, .standalone-fullscreen .page-col-sd, .standalone-fullscreen .comments-container, .standalone-fullscreen #discussion, .standalone-fullscreen .v-footer { display: none !important; }.standalone-fullscreen .reveal { position: fixed !important; top: 0 !important; left: 0 !important; height: 100vh !important; width: 100vw !important; }`
