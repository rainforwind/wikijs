      ...
      if (page) {
        ...
        if (isStandalone) {
          ...
          if (isPubDomain) {
            ...
            if (pubAllowExit) {
              injectCode.css = `${injectCode.css}\n.v-application.standalone-exit .container, .v-application.standalone-exit .container--fluid { width: 100% !important; max-width: 100% !important; }\n.v-application.standalone-exit .reveal-viewport, .v-application.standalone-exit .reveal { position: relative !important; height: auto !important; overflow: visible !important; background: #191919 !important; background-color: #191919 !important; }\n.v-application.standalone-exit .reveal .slides { position: static !important; width: auto !important; height: auto !important; transform: none !important; }\n.v-application.standalone-exit .reveal .slides > section { position: static !important; display: flow-root !important; width: auto !important; height: auto !important; transform: none !important; opacity: 1 !important; visibility: visible !important; margin-bottom: 24px !important; left: auto !important; top: auto !important; background: #191919 !important; background-color: #191919 !important; color: #fff !important; padding: 24px !important; margin-left: 0 !important; margin-right: 0 !important; }\n.v-application.standalone-exit .reveal .slides > section *,\n.v-application.standalone-exit .reveal .slides > section h1,\n.v-application.standalone-exit .reveal .slides > section h2,\n.v-application.standalone-exit .reveal .slides > section h3,\n.v-application.standalone-exit .reveal .slides > section p,\n.v-application.standalone-exit .reveal .slides > section li,\n.v-application.standalone-exit .reveal .slides > section pre,\n.v-application.standalone-exit .reveal .slides > section code { color: #fff !important; }\n.v-application.standalone-exit .reveal .slides > section a { color: #42affa !important; }\n#fs-toggle-btn { position: fixed !important; bottom: 30px !important; right: 30px !important; z-index: 999999 !important; background: #1976d2 !important; color: #fff !important; border: none !important; border-radius: 24px !important; padding: 12px 24px !important; cursor: pointer !important; font-size: 16px !important; box-shadow: 0 2px 8px rgba(0,0,0,0.3) !important; display: flex !important; align-items: center !important; gap: 8px !important; }`
