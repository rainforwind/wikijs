        ...
        if (page.render && page.editorKey === 'code') {
          ...
          if (fullDocMatch) {
            ...
            const iframeSrc = rawContent
              ...
              .replace(/</g, '&lt;')
              .replace(/>/g, '&gt;')
            // Iframe: no inline positioning — CSS handles all states (fullscreen/relative)
            page.render = `<iframe id="raw-page-frame" srcdoc="${iframeSrc}" style="border:none;" allowfullscreen></iframe>`
